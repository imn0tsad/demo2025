...
Шпаргалка для демонстрационного экзамена по системному администрированию

## Сетевая топология

*Схема сети будет добавлена отдельно*
...
- Убедитесь, что все IP-адреса соответствуют схеме сети
- Проверьте firewall настройки при необходимости
- Сохраняйте резервные копии конфигурационных файлов перед изменениями
- Всегда тестируйте соединения после настройки

*Создано для демонстрационного экзамена по системному администрированию 2025*
